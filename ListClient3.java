 ...
 *
 * Test client class called ListClient3 - instantiates ArrayList and LinkedList and tests the AbstractList class's methods
*/
...
public class ListClient3 {
    ...
    public static void processList(List<Integer> list) { // Melina Perraut (added additional test cases and println
                                                         // statements)
        list.add(93);
        ...
        try { // Diane - added try/catch
            System.out.println("Value at index 5 of original list: " + list.get(5)); // Should throw
        ...
        System.out.println("Position of first occurrence of -5 in original list: " + list.indexOf(-5)); // Should return
                                                                                                        // -1
